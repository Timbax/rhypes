...
<link rel="shortcut icon" href="{{asset('plugins/bootstrap/img/favicon.ico')}}">
   ...
   <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <a class="navbar-brand" href="index.html"> <img alt="Charisma Logo" src="{{asset('plugins/bootstrap/img/logo20.png')}}" class="hidden-xs"/>
            ...
            <div class="box-content">
                <form role="form">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="123ABC">
                    </div>
                    <div class="form-group">
                       
                        <label >TARJETA DE OPERACIÓN</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Tarjeta">
                    </div>

                    <div class="form-group">
                       
                        <label >SOAT</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Soat">
                    </div>

                    <div class="form-group">
                       
                        <label >LICENCIA DE TRANSITO</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Licencia de transito">
                    </div>

                    <div class="form-group">
                       
                        <label >SEGURO CONTRACTUAL</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Seguro Contractual">
                    </div>

                    <div class="form-group">
                       
                        <label >SEGURO EXTRA-CONTRACTUAL</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Seguro extra-contractual">
                    </div>

                    <div class="form-group">
                       
                        <label >TECNOMECANICA </label>
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Tecnomecanica">
                    </div>

                    <div class="form-group">
                       
                        <label >SEGURO CONTRA TODO RIESGO</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Seguro contra riesgo">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <p class="help-block">Foto de la placa del vehiculo.</p>
                    </div>
